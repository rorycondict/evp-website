...
/**
 * Full terms of service page. The first section (title + summary) is always
	...
	return (
		<div className="flex w-full flex-col overflow-x-hidden">
			<PageMeta
				...
				description="The legal terms governing your use of the Edinburgh VenturePoint website and services."
			/>

			<section className="mx-auto flex w-full max-w-4xl flex-col items-center px-6 pt-30 pb-10 text-center md:pt-60">
				<UnderlinedTitle title="Terms of Service" />
				<motion.p
				...
				>
					...
					personally or on behalf of an entity, and Edinburgh VenturePoint, concerning your access
					to and use of our Services.
					<br />
					<br />
					By accessing the Services, you have read, understood, and agreed to be bound by all of
					these Legal Terms.
				</motion.p>
			</section>
			...
			<div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 pt-10 pb-30">
				<PolicyDropdown id="agreement" title="Agreement to our legal terms">
					<p>
						We are Edinburgh VenturePoint ('Company', 'we', 'us', or 'our'). We operate the website{' '}
						<TextLink to="/">www.edinburghventurepoint.com</TextLink> (the 'Site'), as well as any
						other related products and services that refer or link to these legal terms (the 'Legal
						Terms') (collectively, the 'Services').
					</p>
					<p>
						These Legal Terms constitute a legally binding agreement made between you, whether
						personally or on behalf of an entity ('you'), and Edinburgh VenturePoint, concerning
				...
				<PolicyDropdown id="intellectual-property" title="2. Intellectual property rights">
					<h3 className="text-xl font-bold">Our intellectual property</h3>
					<p>
					...
					<h3 className="text-xl font-bold">Your use of our services</h3>
					<p>
					...
					<p>
						...
						Marks. Any breach of these Intellectual Property Rights will constitute a material
					...
					<p>
						...
						(b) any third party&rsquo;s intellectual property rights, or (c) applicable law.
					</p>
				</PolicyDropdown>

				<PolicyDropdown id="user-representations" title="3. User representations">
				...
				<PolicyDropdown id="third-party" title="5. Third-party websites and content">
					...
					<p>
						...
						us. If you decide to leave the Services and access the Third-Party Websites or to use or
						install any Third-Party Content, you do so at your own risk, and you should be aware
						these Legal Terms no longer govern. You agree and acknowledge that we do not endorse the
						products or services offered on Third-Party Websites and you shall hold us blameless
				...
				<PolicyDropdown id="services-management" title="6. Services management">
					...
					<ol className="list-decimal pl-6">
						...
						<li>
							...
							the Services or otherwise disable all files and content that are excessive in size or
				...
				<PolicyDropdown id="privacy-policy" title="7. Privacy policy">
					...
					<p>
						...
						United Kingdom. If you access the Services from any other region of the world with laws
						or other requirements governing personal data collection, use, or disclosure that differ
						from applicable laws in the United Kingdom, then through your continued use of the
						Services, you are transferring your data to the United Kingdom, and you expressly
						consent to have your data transferred to and processed in the United Kingdom.
					</p>
				</PolicyDropdown>
				...
				<PolicyDropdown id="governing-law" title="10. Governing law">
					<p>
						...
						provisions of the law in your country to residence. Edinburgh VenturePoint and yourself
						both agree to submit to the non-exclusive jurisdiction of the courts of Edinburgh, which
						means that you may make a claim to defend your consumer protection rights in regards to
						these Legal Terms in the United Kingdom, or in the EU country in which you reside.
					</p>
				</PolicyDropdown>
				...
				<PolicyDropdown id="disclaimer" title="12. Disclaimer">
					<p>
						...
						RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORISED ACCESS TO OR
				...
				<PolicyDropdown id="liability" title="13. Limitations of liability">
					<p>
						...
						AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US. CERTAIN US STATE LAWS
				...
				<PolicyDropdown id="indemnification" title="14. Indemnification">
					<p>
						...
						attorneys&rsquo; fees and expenses, made by any third party due to or arising out of:
